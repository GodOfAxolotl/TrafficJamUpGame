class LevelFactory {
  ...
  Level getLevel(int id) {
    ...
    switch(id) {   
    case -1:
      c = new Car[5];   //remember to change this length!!!
      ...
      // Level(String id, int x, int y, int goalLine, Car[] c)
      return l;

    case 0:
      c = new Car[3];
      c[0] = fac.getCar(4010, 9000, 0, 4);
      c[1] = new Car(9001, 4, 6, 1, 1, Direction.UNMOVABLE, 5);
      c[2] = new Car(9002, 6, 6, 1, 1, Direction.UNMOVABLE, 6);
      l = new Level("Tutorial: Bewege den Cursor mit WASD und ziehe das Auto unter dem Cursor mit den Pfeiltasten!", 10, 8, 4, c);
    ...
    case 2: 
      ...
      c[3] = new Car(9003, 5, 6, 1, 1, Direction.UNMOVABLE, 1);
      c[4] = new Car(9004, 2, 1, 1, 1, Direction.UNMOVABLE, 1);
    ...
    case 6: 
      c = new Car[1];
      c[0] = new Car(4000, 0, 4, 2, 1, Direction.EAST, 12);
      l = new Level("Level 6", 10, 8, 4, c);
      return l;

    case 7: 
      c = new Car[1];
      c[0] = new Car(4000, 0, 4, 2, 1, Direction.EAST, 12);
      l = new Level("Level 7", 10, 8, 4, c);
      return l;

    case 8: 
      c = new Car[1];
      c[0] = new Car(4000, 0, 4, 2, 1, Direction.EAST, 12);
      l = new Level("Level 8", 10, 8, 4, c);
      return l;

    case 9: 
      c = new Car[1];
      c[0] = new Car(4000, 0, 4, 2, 1, Direction.EAST, 12);
      l = new Level("Level 9", 10, 8, 4, c);
      return l;

    case 10: 
      c = new Car[1];
      c[0] = new Car(4000, 0, 4, 2, 1, Direction.EAST, 12);
      l = new Level("Level 10", 10, 8, 4, c);
      return l;
